...
class Tambah_User extends CI_Controller
{
	...
	public function index()
	{
		$data = array(
			...
			"menu" => getmenu(),
			"aktif" => "tambah_user",
			"content" => "user/tambah_user.php",
		);

		// print_r($data['id']);exit;
		$this->breadcrumb->append_crumb('Admin', site_url('user'));
	...
	{
		$data = array(
			"alat_berat" => $this->M_Tambah_User->getAlatBeratById($id),
		);
		// print_r($data);exit;
	...
	public function edit()
	{
		...
		$cek = $this->M_Tambah_User->prosesEdit($id);
	...
	public function delete($id)
	{
		if ($id == "") {
			...
			$cek = $this->M_Tambah_User->delete($id);
