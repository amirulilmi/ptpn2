    ...
    <ul class="nav navbar-nav navbar-right">
      <li class="dropdown dropdown-user">
        <a class="dropdown-toggle" data-toggle="dropdown">
          ...
          <span><?php echo getnama($this->session->userdata('id_penduduk')); ?></span> As <?php if($this->session->userdata('level')==1){echo "Superadmin";}elseif($this->session->userdata('level')==2){echo "Admin";}else{echo "User";} ?>
          <i class="caret"></i>
        </a>
