    ...
    <div class="panel-body">
        ...
        <div class="form-group">
          ...
          <div class='col-md-9'>
            <select data-placeholder="Pilih Tanggal" name="date" class="select-clear">
              <?php $tanggal = $this->db->distinct()->select('date')->get('laporan_kerja_alat_berat')->result(); ?>
              <option value=""></option>
              <?php
              $no = 0;
        ...
        <div class="form-group">
          ...
          <div class='col-md-9'>
            <select data-placeholder="Pilih Jenis Alat" name="jenis" class="select-clear">
              <?php
              $this->db->select(['daftar_alat_berat.id', 'daftar_alat_berat.jenis', 'COUNT(laporan_kerja_alat_berat.id_alat) AS jumlah_laporan_kerja'])
                ->from('laporan_kerja_alat_berat')
                ->join('daftar_alat_berat', 'daftar_alat_berat.id = laporan_kerja_alat_berat.id_alat')
                ->group_by('laporan_kerja_alat_berat.id_alat');
      ...
      <div class="row">
        <div class="form-group">
          ...
          <div class='col-md-9'>
            <select data-placeholder="Pilih Status" name="kondisi_alat_berat" class="select-clear">
              <option value=""></option>
