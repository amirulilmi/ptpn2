<div class="panel panel-primary border-radius m10p">
    <div class="panel-heading header-radius">
        <h9 class="panel-title"><i class="icon-book"></i> Laporan Bell Cane</h9>
    </div>
    <form action="<?php echo site_url('Laporan_Bell/eks'); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class='col-md-9'>
                        <select data-placeholder="Pilih Bulan" name="month" class="select-clear">
                            <?php $bulan = $this->db->distinct()->select('month')->get('bell_cane')->result(); ?>
                            <option value=""></option>
                            <?php
                            $no = 0;
                ...
                <div class="form-group">
                    ...
                    <div class='col-md-9'>
                        <select data-placeholder="Pilih Tanggal" name="date" class="select-clear">
                            <?php $tanggal = $this->db->distinct()->select('date')->get('bell_cane')->result(); ?>
                            <option value=""></option>
                            <?php
                            $no = 0;
