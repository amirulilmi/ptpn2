                ...
                <form action="" id="submit" method="post">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                <label class='col-md-3'>Merk</label>
                                <div class='col-md-9' style="margin-bottom:5px"><input required type="text" id="merk" name="merk" autocomplete="off" placeholder="Masukkan Merk Berat" class="form-control"></div>
                            </div>
                            <div class="form-group">
                                <label class='col-md-3'>Horse Power</label>
                                <div class='col-md-9' style="margin-bottom:5px"><input required type="text" id="horse_power" name="horse_power" autocomplete="off" placeholder="Masukkan Horse Power Alat Berat" class="form-control"></div>
                            </div>
                            <div class="form-group">
                                <label class='col-md-3'>Bahan Bakar</label>
                                <div class='col-md-9' style="margin-bottom:5px"><input required type="text" id="bahan_bakar" name="bahan_bakar" autocomplete="off" placeholder="Masukkan Bahan Bakar Alat Berat" class="form-control"></div>
                            </div>
                            <div class="form-group">
                                <label class='col-md-3'>Tahun Perolehan</label>
                                <div class='col-md-9' style="margin-bottom:5px"><input required type="text" id="tahun_perolehan" name="tahun_perolehan" autocomplete="off" placeholder="Masukkan Tahun Perolehan Alat Berat" class="form-control"></div>
                            </div>
                            <div class="form-group">
                                <label class='col-md-3'>Jumlah Unit</label>
                                <div class='col-md-9' style="margin-bottom:5px"><input required type="text" id="jumlah_unit" name="jumlah_unit" autocomplete="off" placeholder="Masukkan Jumlah Unit Alat Berat" class="form-control"></div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#submit').submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: '<?php echo site_url('Alat_Berat/add'); ?>',
                type: "POST",
