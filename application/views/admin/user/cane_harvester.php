...
<script type="text/javascript">
    ...
    function myfun() {
        $('#data').DataTable({
            "ajax": {
                "url": "<?php echo base_url('Cane_Harvester/get') ?>",
                "type": "POST",
                "data": function() {
                    return {
                        pelatihan: $('#kata').val(),
    ...
    $(document).ready(function() {
        $('#submit').submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: '<?php echo site_url('Cane_Harvester/add'); ?>',
                type: "POST",
    ...
    function byid(id) {
        ...
        $.ajax({
            type: "GET",
            url: "<?php echo base_url('Cane_Harvester/byid/') ?>" + id,
            dataType: "JSON",
            success: function(response) {
                $('[name="id"]').val(response.cane_harvester['id']);
                $('[name="date"]').val(response.cane_harvester['date']);
                $('[name="kebun"]').val(response.cane_harvester['kebun']);
                $('[name="no_unit"]').val(response.cane_harvester['no_unit']);
                $('[name="hi_besar_jtt"]').val(response.cane_harvester['hi_besar_jtt']);
                $('[name="sdhi_besar_jtt"]').val(response.cane_harvester['sdhi_besar_jtt']);
                $('[name="hi_kecil_jtt"]').val(response.cane_harvester['hi_kecil_jtt']);
                $('[name="sdhi_kecil_jtt"]').val(response.cane_harvester['sdhi_kecil_jtt']);
                $('[name="hi_jh"]').val(response.cane_harvester['hi_jh']);
                $('[name="sdhi_jh"]').val(response.cane_harvester['sdhi_jh']);
                $('[name="rataan_jh"]').val(response.cane_harvester['rataan_jh']);
                $('[name="hi_10ton_etd"]').val(response.cane_harvester['hi_10ton_etd']);
                $('[name="sdhi_10ton_etd"]').val(response.cane_harvester['sdhi_10ton_etd']);
                $('[name="hi_7ton_etd"]').val(response.cane_harvester['hi_7ton_etd']);
                $('[name="sdhi_7ton_etd"]').val(response.cane_harvester['sdhi_7ton_etd']);
                $('[name="hi_total_etd"]').val(response.cane_harvester['hi_total_etd']);
                $('[name="sdhi_total_etd"]').val(response.cane_harvester['sdhi_total_etd']);
                $('[name="hi_efektif_hm"]').val(response.cane_harvester['hi_efektif_hm']);
                $('[name="sdhi_efektif_hm"]').val(response.cane_harvester['sdhi_efektif_hm']);
                $('[name="hi_loading_hm"]').val(response.cane_harvester['hi_loading_hm']);
                $('[name="sdhi_loading_hm"]').val(response.cane_harvester['sdhi_loading_hm']);
                $('[name="hi_prestasi"]').val(response.cane_harvester['hi_prestasi']);
                $('[name="sdhi_prestasi"]').val(response.cane_harvester['sdhi_prestasi']);
                $('[name="hari_kerja_efektif"]').val(response.cane_harvester['hari_kerja_efektif']);
                $('[name="waktu_mulai"]').val(response.cane_harvester['waktu_mulai']);
                $('[name="waktu_selesai"]').val(response.cane_harvester['waktu_selesai']);
                $('[name="keterangan"]').val(response.cane_harvester['keterangan']);
    ...
    $(document).ready(function() {
        $('#edit').submit(function(e) {
            e.preventDefault();
            $.ajax({
                url: '<?php echo base_url(); ?>Cane_Harvester/edit',
                type: "POST",
                data: new FormData(this),
                processData: false,
                contentType: false,
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                if (result.isConfirmed) {
                    $.ajax({
                        type: "GET",
                        url: "<?php echo base_url('Cane_Harvester/delete/') ?>" + id,
                        dataType: "JSON",
                        success: function(response) {
                            if (response.status == 'success') {
                                Swal.fire({
