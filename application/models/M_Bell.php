...
class M_Bell extends CI_Model
{
    ...
    public function getByDate()
    {
        $this->db->select('date');
        $this->db->distinct();
        $query = $this->db->get('bell_cane');
        return $query->result_array();
    }

    public function get()
    {
        return $this->db->get('bell_cane')->result_array();
    }
    ...
    public function add()
    {
        ...
        $this->db->insert('bell_cane', $data);
        return 1;
    }

    public function getCaneHarvesterById($id){
        return $this->db->get_where('bell_cane', ['id' => $id])->row_array();
    }
    ...
    public function prosesEdit($id){
        ...
        $this->db->where('id', $id);
        $this->db->update('bell_cane', $data);
        return 1;
    }

    public function delete($id){
        $this->db->where('id', $id);
        $this->db->delete('bell_cane');
        return 1;
    }
    // public function getByDate()
    // {
